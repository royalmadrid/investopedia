...
Bonds
    ...
    A typical corporate bond might have a face value of $1,000 and pay semi-annual taxable interest. Interest on municipal bonds is exempt from federal taxes and may be exempt from state taxes, for residents who live in the issuing state. Interest on U.S. Treasury bonds and bills are taxed at the federal level only.
    Bonds can be purchased as new offerings, or they may be procured through the secondary market. A bond’s value can fluctuate based on a multitude of factors, but it's chiefly influenced by prevailing interest rates.
